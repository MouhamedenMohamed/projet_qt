...
void UserInterface::on_pushButton_addNewBD_clicked()
{

}


void UserInterface::on_comboBox_AjoutRecherche_activated(int index)
{

}


void UserInterface::on_comboBox_AjoutRecherche_currentTextChanged(const QString &arg1)
{
    QString db=ui->lineEdit_ajoutRecherche->text();
    db+=".db";

    QSqlDatabase mydb=QSqlDatabase::addDatabase("QSQLITE");
    mydb.setDatabaseName("C:/sqlite3/mydbdb.db");
    ...
    if(mydb.open()){
        ...
        if(arg1=="Ajouter"){
            ...
            query.prepare("INSERT INTO mydatabases (dbname) VALUES (:db)");
...
void UserInterface::on_pushButton_validerAjoutSuppression_clicked()
{
    QString db=ui->lineEdit_ajoutRecherche->text();
   // db+=".db";
    ...
    QSqlQuery query;
    if(ui->comboBox_AjoutRecherche->currentText()=="Ajouter"){

        query.prepare("INSERT INTO mydatabases(dbname) VALUES (:db)");
        query.bindValue(":db",db);
        query.exec();

    }else if(ui->comboBox_AjoutRecherche->currentText()=="Supprimer"){

        query.prepare("delete from mydatabases where dbname=:db");
        query.bindValue(":db",db);
        query.exec();
}   }
