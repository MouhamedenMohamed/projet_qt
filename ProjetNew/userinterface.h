...
private slots:
    ...
    void on_pushButton_addNewBD_clicked();

    void on_comboBox_AjoutRecherche_activated(int index);

    void on_comboBox_AjoutRecherche_currentTextChanged(const QString &arg1);

    void on_pushButton_validerAjoutSuppression_clicked();
